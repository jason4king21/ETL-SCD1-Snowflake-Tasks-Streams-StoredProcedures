...
Execute the below code in the snowflake worksheet to create a snow task to execute the above created stored procedure every 1 min
...
.
Alter the above created snowflake task to RESUME by running the following query in the SQL worksheet
